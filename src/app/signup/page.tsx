                ...
                <CardContent className="px-10 py-12 flex flex-col justify-center">
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <Input type="text" placeholder="John Doe" className="mt-1 focus-visible:ring-emerald-500" />
                        </div>

                        <div>
                            <Label className="text-gray-700">Email</Label>
                            <Input type="email" placeholder="you@example.com" className="mt-1 focus-visible:ring-emerald-500" />
                        </div>

                        <div>
                            <Label className="text-gray-700">Password</Label>
                            <Input type="password" placeholder="••••••••" className="mt-1 focus-visible:ring-emerald-500" />
                        </div>
                        ...
                        <p className="text-sm text-center text-gray-500">
                            ...
                            <Link href={'/signin'} className="text-emerald-600 font-semibold hover:underline cursor-pointer">
                                Sign In
                            </Link>
                        </p>
                    </div>
